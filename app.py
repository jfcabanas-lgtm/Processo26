...
# 1. Configurações de Layout e Estilo
...
def extrair_dados_pdf(file):
    ...
    # Data do Despacho/Liquidação (busca a data mais recente do documento)
    ...
    dados["gestor"] = re_gestor.group(1).strip() if re_gestor else "Ana Marcia R. S. Marcelino"
...
st.markdown("<h4 style='text-align: center;'>Checklist Oficial de Auditoria (19 Itens)</h4>", unsafe_allow_html=True)
st.divider()
...
if file:
    ...
    # Montagem do Checklist (1 a 19)
    # Item 1 com a formatação solicitada: NE (Gerando a NL de Data)
    obs_item_1 = f"{d['empenho']} (Gerando a {d['liquidacao']} de {d['data_proc']})"
    ...
    checklist_19 = [
        ...
        {"ITEM": 18, "EVENTO": "Folha de pagamento", "S/N/NA": "S", "OBSERVAÇÕES": "Competência 01/2026"},
